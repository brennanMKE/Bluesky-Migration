...
| [0066](issues/0066.md) | Module 15 gate (iOS): remaining screens feature parity on iPhone | BlueskyLists / BlueskyFeed / BlueskyModeration / BlueskySettings | iOS | resolved |
...
| [0156](issues/0156.md) | iPhone bottom tab bar: profile-tab avatar selected-state has an oversized ring; tab spacing off | Bluesky-SwiftUI / BlueskyUI | iOS | resolved |
...
| [0184](issues/0184.md) | Search result rows don't navigate: SearchScreen mounted without onActorTap/onPostTap | BlueskySearch / Bluesky-SwiftUI | All | resolved |
| [0185](issues/0185.md) | UI-test navigator openSettings/openModeration intents don't reliably push on iOS | Tests / Bluesky-SwiftUI | iOS | resolved |
