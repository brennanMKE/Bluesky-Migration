...
![Reference: RN reply row with "↳ Replied to you"](notifications-rn.png)
![Current: SwiftUI reply row treated like any other notification](notifications-swiftui.png)
